...
(6, '2022_12_31_125200_create_sessions_table', 1),
(7, '2022_12_31_143540_create_piscinas_table', 1),
(8, '2022_12_31_212116_add_user_id_to_piscinas_table', 1);
...
CREATE TABLE `piscinas` (
  ...
  `alturaMax_em_cm` double(8,2) NOT NULL,
...
ALTER TABLE `piscinas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `piscinas_user_id_foreign` (`user_id`);
...
--
-- Limitadores para a tabela `piscinas`
--
ALTER TABLE `piscinas`
  ADD CONSTRAINT `piscinas_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
COMMIT;
